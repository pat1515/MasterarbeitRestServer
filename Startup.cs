...
namespace MasterarbeitRestServer
{
    public class Startup
    {
        ...
        {            
            ...
            conString += "Data Source=(description=(address=(protocol=tcps)(port=1522)(host=adb.eu-frankfurt-1.oraclecloud.com))(connect_data=(service_name=ok6xrgnsfgkpak1_masterarbeitdb_high.adb.oraclecloud.com))(SECURITY = (MY_WALLET_DIRECTORY = D:\\home\\site\\repository\\DB)));";
